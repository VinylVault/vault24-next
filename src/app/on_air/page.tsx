...
export default function OnAir() {
    ...
    return (
        <div className="flex min-h-screen flex-col items-center p-24 bg-vault-background">
            ...
            <h3 className='text-8xl font-bold font-title text-vault-title'>The Vinyl Vault Live Page</h3>
            <iframe src="https://player.twitch.tv/?channel=vinylvault&parent=localhost"></iframe>
