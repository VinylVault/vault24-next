...
export default function ShowArchiveDetails() {
    ...
    return (
        <div className="flex min-h-screen flex-col items-center p-24 bg-vault-background">
            ...
            <h3 className='text-8xl font-bold font-title text-vault-title'>The Vinyl Vault <span className='text-vault-link capitalize'>{params.showSlug}</span> Archive Show Details Page</h3>
        </div>
    )
}