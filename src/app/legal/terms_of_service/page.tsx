  ...
  return (
    <div className="flex min-h-screen flex-col items-center p-24 bg-vault-background">
      ...
      <h3 className="text-8xl font-bold font-title text-vault-title">
        The Vinyl Vault Show Terms Of Service
      </h3>

      <p className="big">
        <strong>
          These terms and conditions outline the rules and regulations for the
          use of The Vinyl Vault's Website.
        </strong>
      </p>
      <p className="big">
        By accessing this website we assume you accept these terms and
        conditions in full. Do not continue to use The Vinyl Vault's website if
      ...
      <h2>Cookies</h2>
      <p className="big">
        We employ the use of cookies. By using The Vinyl Vault's website you
      ...
      <p className="big">You must not:</p>
      <p className="big">
        <ol>
          <li>
            <p className="big">
      ...
      <p className="big">
        ...
        <ol>
          ...
          <li>
            <p className="big">
              <strong>dot.com community sites;</strong>
            </p>
          </li>
          <li>
            <p className="big">
          ...
          <li>
            <p className="big">
              <strong>online directory distributors;</strong>
            </p>
          </li>
          <li>
            <p className="big">
          ...
          <li>
            <p className="big">
              <strong>educational institutions and trade associations.</strong>
            </p>
          </li>
        </ol>
      </p>
      <p className="big">
        ...
        The Vinyl Vault Show; and (d) where the link is in the context of
      ...
      <p className="big">
        ...
        e-mail to{' '}
        <a
          href="mailto:business@thevinylvaultshow.co.uk"
          title="send an email to business@thevinylvaultshow.co.uk"
        >
          business@thevinylvaultshow.co.uk
        </a>
      ...
      <ol>
        <li>
          <p className="big">
            <strong>By use of our corporate name; or</strong>
          </p>
        </li>
        <li>
          <p className="big">
