export default function LegalTermsOfService() {
  return (
    <div className="flex min-h-screen flex-col p-12 bg-vault-background">
      ...
      <p className="text-vault-text text-xl px-4 py-2">You must not:</p>
      <p className="text-vault-text text-xl px-4 py-2">
        <ol>
          <li>
      ...
      <p className="text-vault-text text-xl px-4 py-2">
        ...
        e-mail to
        <a
          href="mailto:studio@thevinylvaultshow.co.uk"
          title="send an email to studio@thevinylvaultshow.co.uk"
        >
          studio@thevinylvaultshow.co.uk
        </a>
      ...
      <h3 className="text-vault-text font-bold text-2xl py-4">Disclaimer</h3>
      <p className="text-vault-text text-xl px-4 py-2">
