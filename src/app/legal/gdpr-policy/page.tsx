  ...
  return (
    <div className="flex min-h-screen flex-col items-center p-24 bg-vault-background">
      ...
      <h3 className="text-8xl font-bold font-title text-vault-title">
        The Vinyl Vault Show GDPR Policy
      </h3>

      <Link href={'/library/shelves/shelf-1'}>Shelf 1</Link>
      <br />
      <Link href={'/library/shelves/shelf-2'}>Shelf 2</Link>
      <br />
      <Link href={'/library/shelves/shelf-3'}>Shelf 3</Link>
      <br />
      <Link href={'/library/shelves/shelf-4'}>Shelf 4</Link>
      <br />
    </div>
  );
}
