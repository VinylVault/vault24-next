...
export function ShelfGridItems({
    ...
    return(
        ...
        <div className="flex flex-col gap-2 w-full shadow-lg shadow-vault-menubar hover:shadow-vault-link rounded-xl">
            <a href={`/the_vault/releases/${genreSlug}`} className="aspect-video w-full rounded-xl overflow-hidden ">
                <Image 
            ...
            <div className="flex flex-col">
                ...
                <p className="text-vault-text mx-2 mb-1 font-title text-lg">{genreCount + " Releases"}</p>
            </div>
