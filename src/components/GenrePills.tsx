...
export function GenrePills({
  ...
  return (
    <div
      ref={containerRef}
      className="overflow-x-hidden relative bg-vault-background"
    >
      <div
        className="flex bg-vault-background mb-4 whitespace-nowrap gap-3 transition-transform w-[max-content]"
